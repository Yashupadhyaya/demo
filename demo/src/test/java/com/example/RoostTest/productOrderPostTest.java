        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
				...
				.header("x-request-id", testData.get("x-request-id") != null ? testData.get("x-request-id") : "")
				.header("x-service-host", testData.get("x-service-host") != null ? testData.get("x-service-host") : "")
