...
public class productOrderOrderIdPatchTest {
    ...
    public void productOrderOrderIdPatch_Test() throws JSONException {
        ...
        for (Map<String, String> testData : envList) {
          ...
          if(testData.get("RequestBody") != null){
              requestBodyObject = new JSONObject(testData.get("RequestBody"));
				...
				.header("X-Username", testData.get("X-Username"))
                .when()
      ...
      switch(Integer.toString(responseObj.statusCode()).charAt(0)){
              ...
              if (response.get("message.Yash") != null) {  
                MatcherAssert.assertThat(response.get("message.Yash"), instanceOf(String.class));  
                MatcherAssert.assertThat(response.getString("message.Yash"), anyOf(equalTo("S"), equalTo("T"), equalTo("E")));
  
                MatcherAssert.assertThat(response.getString("message.Yash").length(), lessThanOrEqualTo(1));
